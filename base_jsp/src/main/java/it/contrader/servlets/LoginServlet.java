...
public class LoginServlet extends HttpServlet {
	...
	public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request != null) {
			...
			request.setAttribute("idSession", dto.getId());
			request.getSession().setAttribute("idSession", dto.getId());
			...
			case "RISTORATORE":
				getServletContext().getRequestDispatcher("/HomeRistoratore.jsp").forward(request, response);
				break;
